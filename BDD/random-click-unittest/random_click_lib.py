...
def setup_target_device(device, android_serial):
    ...
    logging.debug("STEP: start setting up target")
    ...
    try:
        ...
        # bootstrap_farom_unknown_state(android_serial)
        ...
        logging.error('error occur during finding the target device')

        logging.error('dump the value of: device')
