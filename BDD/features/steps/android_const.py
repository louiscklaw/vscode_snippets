...
class android_os_permission_button():
    PERMISSION_ALLOW=1
    PERMISSION_DENY=0

class android_key_const():
    # NOTE extract fromhttps://developer.android.com/reference/android/view/KeyEvent.html
    # port from https://github.com/appium/java-client/blob/master/src/main/java/io/appium/java_client/android/AndroidKeyCode.java
